...
class DistrictToggleButton extends StatefulWidget {
  const DistrictToggleButton() : super(key: key);

  @override
  _DistrictToggleButtonState createState() => _DistrictToggleButtonState();
}

class _DistrictToggleButtonState extends State<DistrictToggleButton> {
  @override
  Widget build(BuildContext context) {
    return Positioned(
      top: 240,
      ...
      child: Container(
        child: Column(children: <Widget>[
          SizedBox(
            height: 30,
            child: FlatButton(
              color: dhakacity.isVisited ? Colors.green : Colors.red,
              shape: CircleBorder(),
              onPressed: () => {
                setState(() {
